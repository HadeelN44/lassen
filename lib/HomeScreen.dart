          ...
          child: Row(
            ...
            children: [
              Row(
               ...
               GestureDetector(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder:  (BuildContext context) => Challenge()));
                },
                 child: Text(
                  'التـــحديــات',
                  textAlign: TextAlign.right,
              ...
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    Container(
                      child: Text(
                      'أن يكون طموح كل مهتم وراغب لتمكين معرفته اللُّغوية وزيادة حصيلته وتنمية إمكانياته باستخدام وسائل الترفيه الحديثة، ويسعى أن يكون مؤثرًا إيجابيًا مساهمًا في رفع الإمكانيات وزيادة المعرفة ومخرج وطني مشرّف.',
                       textAlign: TextAlign.right,
                      style: TextStyle(
                          color: Colors.black,
                          fontSize: 14,
                ...
                SizedBox(width: 24,),
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 10,),
                     Text(
                        'مد يد العون للشباب للتنمية والتمكين اللغوي من خلال تزويدهم بالمعرفة الأساسية والأدوات والطرق الموصلة لذلك، وبناء أسس وركيزة ترفيهية مساندة لرفع حصيلتهم اللغوية بوسائل مستدامة وتنموية.',
                        textAlign: TextAlign.right,
                        style: TextStyle(
                            color: Colors.black,
                            fontSize: 14,
